  ...
  <div class="content">
    ...
    <div class="container">
     <form name=""  action="Deconnexion" method="post" id="" novalidate>        
     	...
     	<div class="container">
     	<form name="" method="post" action="ChoixBeneficiaire" id="form"class="well form-horizontal">
     	

				<div class="form-group">
  <label> Veuillez choisir le type de bénéficiaire que vous souhaitez ajouter </label>
     	<br>
     <p>	</p>
   <label class="checkbox-inline"><input type="checkbox" value="benInterne" name="type">Bénéficiaire interne à la banque</label>
   <br>
   <p> </p>
<label class="checkbox-inline"><input type="checkbox" value="benExterne" name="type">Bénéficiaire externe à la banque</label>
