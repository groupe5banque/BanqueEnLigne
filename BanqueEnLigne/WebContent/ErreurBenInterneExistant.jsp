...
<body id="page-top" class="index">
  ...
  <div class="content">
    ...
    <div class="alert alert-danger fade in">
        ...
        <strong>Erreur!</strong> Ce client a déja été ajouté à votre liste de bénéficiaires
    </div>
</div>

     	<div class="container">
  <form name="" method="post" action="AjoutBenInterne" id="form"class="well form-horizontal">

			<label> Veuillez saisir l'email du bénéficiaire </label>
  ...
  <input name="mail" placeholder=Email*" class="form-control"  type="email"  required data-validation-required-message="Please enter ">
    </div>
  </div>
</div>
