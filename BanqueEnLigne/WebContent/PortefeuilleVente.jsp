...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%@ page import="java.util.Date" %>
     ...
     bourse.ActualisationBourse(path+"bourse.xls"); */
        ...
        String cmp= (String)session.getAttribute("comptetitre");        
        int idCompte=comptedao.getCompteId(cmp);      
        List<Titre> titres = new ArrayList<Titre>();
        titres= titredao.getListeTitre(identifiant, idCompte);
...
<body id="page-top" class="index">
  ...
  <div class="content">
    ...
    <div class="container">
     ...
     <div class="container">
  <form name="" method="post" action="TraitementActionSelectionVente" id="form"class="well form-horizontal">
  ...
  <table class="table table-bordered">
    ...
    <%for (int i =0; i<titres.size(); i++){ %>
      <tr>
        <td> <input type="checkbox" name="action" value="<%=titres.get(i).getNomTitre()%>">  <%=titres.get(i).getNomTitre() %></td>
