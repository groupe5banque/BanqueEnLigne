...
<meta charset="utf-8">
    ...
    <link href="css/menu.css" rel="stylesheet">
     <link href="css/Epargne.css" rel="stylesheet">
...
<body id="page-top" class="index">
  ...
  <form name=""  action="CompteEpargne" method="post" id="" novalidate>
	<div class="container">
         ...
         <P>xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxCOMPTE ÉPARGNExxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</P>
                   
             <br>   </div>
                <div class="modal-body1">
                    <h4 class="color1">CONDITIONS GÉNÉRALES</h4>
                    <p class="colorD">Un livret qui ne manque pas d'intérêts</p> 
                    <ul style="list-style-type:disc;">
<p><li>Toute personne majeure ou mineure , peut créer un compte Épargne.</li></p>
<p><li> Le taux de votre Compte Sur Livret est de 0.30% par an quels que soient<br> la durée et le montant de votre placement.</li></p>
<p><li>Pas de plafonds de versements : vos dépôts ne sont pas plafonnés.<br> Versements à tout moment et illimités.</li></p>
<p><li>Chaque année, vos intérêts s'ajoutent et produisent à leur tour des<br> intérêts, sans limite de plafond.</li></p>
</ul>
</p>
<p class="colorD">Un livret qui ne vous coûte rien<br></pr>
 <ul style="list-style-type:disc;">
<p><li>Pas de frais d'ouverture et de fermeture.</li></p>
<p><li>Pas de frais de gestion.</li></p>
</ul>
<p class="colorD">Une épargne en toute simplicité<br></pr>
<ul style="list-style-type:disc;">
<p><li>Votre Épargne est disponible à tout moment</li></p>
<p><li>Vous pouvez réaliser toutes vos opérations<br> en ligne de chez vous 24H/24, 7j/7</li></p>
</ul>
                </div>
                <div class="modal-footer1">
                    <div class="btn-group1">
                        <button type="submit"></span> Créer</button>
                    </div>
                </div>
