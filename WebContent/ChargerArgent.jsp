...
<%
	...
	String SoldeCompte;
	Double solde;
	session.setAttribute("IdClient", cl.getIdClient());
%>
	...
	<div class="wrap">
		<nav class="nav-bar navbar-inverse" role="navigation">
			<div id="top-menu" class="container-fluid active">
				<a class="navbar-brand" href="#">BIENVENUE SUR VOTRE ESPACE
					CLIENT</a>
				<ul class="nav navbar-nav">
					...
					<li class="dropdown movable"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"><span
							class="caret"></span><span class="fa fa-3x fa-child"></span></a>
						<ul class="dropdown-menu" role="menu">
							<li><a><span class="fa fa-user"></span> Bienvenue
									${sessionScope.client.nomClient} </a></li>
							<li class="divider"></li>
		...
		<aside id="side-menu" class="aside" role="navigation">
			<ul class="nav nav-list accordion">
				<li class="nav-header">
					<div class="link">
						<i class="fa fa-lg fa-user"></i>Profil<i
							class="fa fa-chevron-down"></i>
					</div>
					<ul class="submenu">
						<li><a href="InfosPersonnellesClient.jsp"> Voir mes
				...
				<li class="nav-header">
					...
					<ul class="submenu">
						...
						<li><a href="Consultation.jsp">Consulter les soldes de
								mes comptes</a></li>
					</ul>
				</li>
				...
				<li class="nav-header">
					...
					<ul class="submenu">
						...
						<li><a href="HistoriqueSelection.jsp">Consulter
								l'historique de mes transactions</a></li>
					</ul>
				</li>
			...
			<section class="content-inner">
				...
				<form id="form" method="POST" action="./ChargerArgent">
					<div class="form-group">
						<label>Choisir le type de compte à charger:&nbsp</label> <select
							id="typeC" name="typeC" onchange="show(this);">
							<option id="CompteE">Compte epargne</option>
							<option id="CompteC">Compte courant</option>
							<option id="CompteT">Compte titre</option>
						</select> <br> <br> <label>Choisir le compte à charger:</label>
						<div id="ce" class="form-group">
							Compte epargne:&nbsp;&nbsp; <select id="typeCE" name="ceChoisi">
								<c:forEach var="compteE" items="${ce}">
									<option value="${compteE.getNumeroDeCompte()}"><c:out
											value="${compteE.getNumeroDeCompte()}" />&nbsp;&nbsp;Solde:
										<c:out value=" ${compteE.getSoldeBanque()}" /></option>
								</c:forEach>
							</select>
						</div>

						<div id="cc" style="visibility: hidden" class="form-group">
							Compte courant: &nbsp;&nbsp; <select id="typeCC" name="ccChoisi">
								<c:forEach var="compteC" items="${cc}">
									<option value="${compteC.getNumeroDeCompte()}"><c:out
											value="${compteC.getNumeroDeCompte()}" />&nbsp;&nbsp;Solde:
										<c:out value=" ${compteC.getSoldeBanque()}" /></option>
								</c:forEach>
							</select>
						</div>


						<div id="ct" style="visibility: hidden" class="form-group">
							Compte titre: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select
								id="typeCC" name="ctChoisi">

								<c:forEach var="compteT" items="${ct}">
									<option value="${compteT.getNumeroDeCompte()}"><c:out
											value="${compteT.getNumeroDeCompte()}" />&nbsp;&nbsp;Solde:
										<c:out value=" ${compteT.getSoldeBanque()}" /></option>
								</c:forEach>
						...
						<br>
						<div class="form-group">
							<label>Montant à charger:</label> <input class="form-control"
								type="text" value="" name="Montant"> <br>
							<button type="submit" class="btn btn-default">Submit</button>

						</div>
						<br> <br> <label id="hint"></label>
				</form>
