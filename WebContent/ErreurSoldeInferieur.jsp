...
<body id="page-top" class="index">
  ...
  <div class="content">
    ...
    <div class="alert alert-danger fade in">
        ...
        <strong>Erreur!</strong> Le solde de votre compte est inférieur au montant que vous souhaitez virer.
    </div>
</div>
     	<div class="container">
  ...
  <c:forEach var="cmp" items = "${compte}">
		...
		<p> </p>
			...
			<div class="form-group"> 
  <label class="col-md-4 control-label"> Compte bénéficiaire </label>
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    ...
    <c:forEach var="cmp" items = "${compte}">
       	<option  value = "${cmp.getNumeroDeCompte()}"> <c:out value="${cmp.getTypeCompte()}"/>&nbsp;&nbsp; - N°  <c:out value=" ${cmp.getNumeroDeCompte()}"/>&nbsp;&nbsp;  Solde:<c:out value=" ${cmp.getSoldeBanque()}"/></option>   	
			...
			<div class="form-group">
  <label class="col-md-4 control-label">Montant à prélever </label>  
  ...
  <input name="montant" placeholder="Montant*" class="form-control"  type="text" required data-validation-required-message="Please enter ">
											...
											<div class="form-group">
  <label class="col-md-4 control-label">Motif du virement (facultatif) </label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
...
<label id="hint"></label>
    ...
    <script>
	   ...
	   function affichageSolde(){
		var select,choice;
		int valeur;
		select = document.getElementById("compteEmetteur");
		choice = select.selectedIndex;
		valeur = select.options[choice].value;
		document.getElementById('solde').value = 3 ;
		return valeur;
