        ...
        <ul class="nav nav-list accordion">                    
          ...
          <li class="nav-header">
            ...
            <ul class="submenu">
              ...
              <li><a href="ChoixCompteTitre.jsp">Vendre des actions</a></li>
   ...
   <section class="content-inner">
    <div class="container">
     <form name=""  action="Deconnexion" method="post" id="" novalidate>        
     	...
     	<div class="container">
  <form name="" method="post" action="TraitementVentes" id=""class="well form-horizontal">
			 <label class="col-md-4 control-label">Veuillez sélectionner le compte titre avec lequel vous souhaitez effectuer la transaction</label>	
			<div class="form-group"> 
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select name="compte" class="form-control selectpicker" >
