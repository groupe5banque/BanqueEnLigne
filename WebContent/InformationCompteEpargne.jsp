  ...
  <div class="content">
    ...
    <section class="content-inner">
     	...
     	<P id= "titre"> LES INFORMATIONS CONCERNANTS VOTRE COMPTE CREE </P>
           <p class = "element"> TYPE DE COMPTE:  ${sessionScope.compte.typeCompte} </p>
           <p class = "element"> NUMERO DE COMPTE:  ${sessionScope.compte.numeroDeCompte} </p>
           <p class = "element"> CLEF DU RIB:  ${sessionScope.compte.clefRIB} </p>
           <p class = "element"> CODE BANQUE :  ${sessionScope.compte.codeBanque} </p>
           <p class = "element"> SOLDE COMPTE : ${sessionScope.compte.soldeBanque} </p>
