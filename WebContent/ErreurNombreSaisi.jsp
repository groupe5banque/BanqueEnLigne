...
<body id="page-top" class="index">
  ...
  <div class="content">
    ...
    <section class="content-inner">
     ...
     <form name=""  action="AchatActions" method="post" id="" novalidate>        
            <!-- Modal -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Achat d'actions </h4>
                  </div>
                  <div class="modal-body">
                      Nombre d'actions à acheter
                       <div class="input-group">
                               ...
                               *Le nombre d'actions ne peut pas excéder 500 
                                  </div>
                                    </div>
    ...
    <div class="alert alert-danger fade in">
        ...
        <strong>Erreur!</strong> Le nombre saisi est ne doit comporté aucune lettre et ne doit pas être négatif ou nul
    </div>
</div>	
  ...
  <div class="col-md-4">
   <a data-toggle="modal" data-target="#myModal5" > Acheter </a>
