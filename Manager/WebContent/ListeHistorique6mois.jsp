...
<body id="page-top" class="index">
  ...
  <div class="content">
   ...
   if(llh.size()==0)
   {%>
	<H3>IL n'y a pas d'historique dans les 6 mois précédents.</H1>    
  <%
  }
   else{
  %>  
    <section class="content-inner">
     ...
     <form name=""  action="Deconnexion" method="post" id="" novalidate>        
        ...
        <h4 class="text-center"> Reporting sur les historiques 6 mois précédents</h4>
    ...
    <table class="columns" >
      ...
      <%}else{%>
      <td>Il n'y pas de virement émis dans les 6 mois précédents</td>
      <%}%>
      </tr>  
    </table>  
    <br>
    ...
    <table class="columns">
      ...
      <%if(re==0&&rc==0&&rt==0){ %> 
       ...
       <%}else{%>
      <td>Il n'y pas de virement reçue dans les 6 mois précédents</td>
      <%}%>
      </tr>  
    </table>
    <br>
    ...
    <table class="columns">
      ...
      <%}else{%>
      <td>Il n'y pas de dépôt dans les 6 mois précédents</td>
      <%}%>
    </table>
    <br>
